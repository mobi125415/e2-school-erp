...
if _configured_secret:
    ...
    # Keep Flask sessions valid across Vercel invocations. A fresh random
    # secret per invocation would invalidate the login cookie after redirect.
    _secret_seed = "|".join([
        os.environ.get("VERCEL_PROJECT_ID", ""),
        os.environ.get("VERCEL_URL", ""),
        "e2-school-erp-session",
    ])
